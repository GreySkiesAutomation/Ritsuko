...
namespace DefaultNamespace
{
    public class QueryHandler : MonoBehaviour
    {
        ...
        private string _structuredResponseInstructions =
            ...
            "- Do not include timestamp metadata, XML-like tags, reasoning, notes, or explanations in 'reply'.\n" +
            ...
            "- Keep 'reply' to 1 short sentence.\n" +
        ...
        public async void HandleNewMessage(string messageContent, QuerySource source)
        {
            ...
            try
            {
                ...
                SendResponseToSource(structuredAssistantResponse.reply, source, !string.Equals(structuredAssistantResponse.conversationState, "END", StringComparison.OrdinalIgnoreCase));
